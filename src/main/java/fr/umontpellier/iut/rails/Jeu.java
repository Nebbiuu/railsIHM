...
public class Jeu extends Task<Void> implements IJeu {
    ...
    private ObjectProperty<List<IJoueur>> autreJoueurs;
    private ObjectProperty<Joueur> autreJoueur;
    /**
    ...
    public Jeu(String[] nomJoueurs) {
        ...
        autreJoueurs = new SimpleObjectProperty<>();
        autreJoueur = new SimpleObjectProperty<>();
    ...
    public ObjectProperty<Joueur> autreJoueurProperty() {
        return autreJoueur;
    }
    ...
    @Override
    public ObjectProperty<List<IJoueur>> vueAJProperty() {
        return autreJoueurs;
