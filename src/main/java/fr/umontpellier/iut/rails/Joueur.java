...
public class Joueur implements IJoueur {
    ...
    public String getCouleurAnglais(){
        if(getCouleur().name()=="BLEU"){
            return "lightblue";
        }
        else if(getCouleur().name()=="ROSE"){
            return "pink";
        }
        else if(getCouleur().name()=="VERT"){
            return "lightgreen";
        }
        else if(getCouleur().name()=="ROUGE"){
            return "#CD5C5C";
        }
        else if(getCouleur().name()=="JAUNE"){
            return "#DD7B40";
        }
        return null;
    }
